...
<div class="posts">
 ...
 {% if post.description.size > 140 %}{{ post.description | markdownify | remove: '<p>' | remove: '</p>' }}{% else %}{{ post.excerpt | markdownify | remove: '<p>' | remove: '</p>' }}{% endif %} <a href="{{ site.url }}{{ site.baseurl }}{{ post.url }}" title="Read more"><strong>Read more...</strong></a>
  </div>
